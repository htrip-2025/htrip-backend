...
import com.ssafy.htrip.attraction.service.CategoryService;
...
public class FilterController {
    ...
    public ResponseEntity<List<ContentTypeDto>> getContentTypes() {
        List<ContentTypeDto> contentTypes = categoryService.getAllContentTypes();
    ...
    public ResponseEntity<List<CategoryDto>> getMiddleCategories(
            @RequestParam String mainCategory) {
        List<CategoryDto> middleCategories = categoryService.getMiddleCategoriesByMain(mainCategory);
    ...
    public ResponseEntity<List<CategoryDto>> getSubCategories(
        ...
        List<CategoryDto> subCategories = categoryService.getSubCategoriesByMiddle(middleCategory);
